...
const std::vector<MonsterTemplate> MonsterTemplates = {
    { 1, "슬라임", 5, 500, 20, "Agro", "로밍" },
    { 2, "고블린", 10, 800, 40, "Agro", "로밍" },
    { 3, "트롤", 15, 1200, 60, "Agro", "로밍" },
    { 4, "스켈레톤", 20, 1500, 80, "Agro", "로밍" },
    { 5, "좀비", 25, 2000, 100, "Agro", "로밍" },
    { 6, "마법사", 30, 2500, 120, "Agro", "고정" },
    { 7, "드래곤", 50, 10000, 500, "Agro", "고정" }
};